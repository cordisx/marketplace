...
```text
Read the CordisX Marketplace guide, configure this source, and help me find and install the plugin I request: https://raw.githubusercontent.com/cordisx/marketplace/main/llms.txt
```

Tell the assistant which plugin you want. The guide reuses existing Host setup
and links to the documentation Skill for later questions.
